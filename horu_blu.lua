...
-- BlueMagic
	if spell.skill == 'Blue Magic' then
		...
		elseif spell.name == "Battery Charge" and spell.targets == "SELF" then
			equip(sets.midcast.BlueMagic,{head={ name="Amalric Coif", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},})
