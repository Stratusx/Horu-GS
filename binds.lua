...
if player.main_job == "WAR" then
	basic_binds()
	-- set binds
	windower.send_command('@bind ^f10 gs c PDT')
...
elseif player.main_job == "BLU" then
	basic_binds()
	-- set binds
	windower.send_command('bind ^f10 input //gs c PDT')
	windower.send_command('bind ^f11 input //gs c MDT')
	windower.send_command('bind ^f12 input //gs c TP')
...
elseif player.main_job == "THF" then
	basic_binds()
		-- set binds
	windower.send_command('@bind ^f09 gs c TH')
	windower.send_command('@bind ^f10 gs c PDT')
	windower.send_command('@bind ^f11 gs c MDT')
	windower.send_command('@bind ^f12 gs c TP')
